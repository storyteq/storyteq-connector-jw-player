...
if(parameters.verbose){$vm.verbose=!0}
...
connector.videoStarted=!0;connector.createAnalyticView(0)}},}});this.createPlayerButton(response,jwPlayerInstance);this.setEnvironment(jwPlayerInstance.getEnvironment());this.videoEventEmitter(jwPlayerInstance)}
...
StoryteqConnectorJwPlayer.prototype.createAnalyticView=function(percentage){if(!this.track||this.track===undefined||this.track===null){return}
var meta={'percentage':percentage};if(this.verbose){console.log('tracking');console.log(meta)}
this.analyticPostRequest('view',meta)}
StoryteqConnectorJwPlayer.prototype.createAnalyticEmbed=function(){if(!this.track||this.track===undefined||this.track===null){return}
